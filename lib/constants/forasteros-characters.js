...
export const FORASTEROS_RP_CHARACTERS = [
  ...
  {
    name: 'Ramón Cazanuecos',
    channel: 'thecatacroquer',
    server: 'ForasterosRP',
    job: JOBS.UNEMPLOYED,
    keywords: [...JOB_KEYWORDS[JOBS.UNEMPLOYED], 'mente', 'fría']
  },
  {
    name: 'Chibito',
    channel: 'roitwitch',
    server: 'ForasterosRP',
    job: JOBS.POLICE,
    keywords: [...JOB_KEYWORDS[JOBS.POLICE], 'perro']
  },
  {
  ...
  },
  {
    ...
    server: 'ForasterosRP',
    job: JOBS.DEALER,
    keywords: [...JOB_KEYWORDS[JOBS.DEALER], ...GANGS_KEYWORDS[GANGS.YELLOW]]
  },
  {
    name: 'Hache',
    channel: 'magiko666',
    server: 'ForasterosRP',
    job: JOBS.UNEMPLOYED,
    keywords: [...JOB_KEYWORDS[JOBS.UNEMPLOYED], 'zatu']
  },
  {
    name: 'Joseto Morris',
    channel: 'srcheeto',
